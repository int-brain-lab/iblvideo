"""Configuration parameters and network definitions for Lightning Pose estimation pipelines."""
...
SIDE_FEATURES = {
    ...
    'nose_tip': {
        ...
        # batch size for inference; 116 works for 8GB GPU (smaller network)
        'sequence_length': 116,
        'eks_params': {},
    },
    'eye': {
